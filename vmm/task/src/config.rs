        ...
        for p in params {
            ...
            #[cfg(feature = "image-service")]
            {
                parse_cmdline!(
                    param,
                    AA_KBC_PARAMS,
                    config.image_config.aa_kbc_params,
                    String::from
                );
                parse_cmdline!(
                    param,
                    HTTPS_PROXY,
                    config.image_config.https_proxy,
                    String::from
                );
                ...
                parse_cmdline!(
                    ...
                    config.image_config.enable_signature_verification
                );
                // URI of the image security file
                parse_cmdline!(
                    param,
                    IMAGE_POLICY_FILE,
                    config.image_config.image_policy_file,
                    String::from
                );
                ...
                parse_cmdline!(
                    ...
                    config.image_config.image_registry_auth_file,
                    String::from
                );
                ...
                parse_cmdline!(
                    ...
                    config.image_config.simple_signing_sigstore_config,
                    String::from
                );
            }
        }
